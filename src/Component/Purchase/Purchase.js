...
const Purchase = () => {
  ...
  const { _id, Image, Name, Price, Description, Quantity } =
    singleProduct || {};
  ...
  return (
    <div className="m-20 ">
      <div class=" card lg:card-side bg-base-100 shadow-xl border-4 border-red-500">
        <div className="">
          <figure>
            <img className="h-60" src={Image} alt="Album" />
          </figure>
        </div>
        <div class="card-body">
          ...
          <div class="card-actions  items-center">
            ...
            <button className="m-1 btn btn-warning" onClick={handleDecrease}>
              Decrease
            </button>
          </div>
          ...
          <div className=" mt-4 order-style d-flex justify-content-center align-items-center">
            <div className="flex justify-between">
              <h4 className="border-2 p-2 border-red-400">
                Price: <b>{Price}</b>{" "}
              </h4>
              <h4 className="border-2 p-2 border-red-400">
                Quantity: <b>{newQuantity}</b>{" "}
              </h4>
              ...
              <button
                ...
                className="btn btn-primary bg-orange-400 m-1 "
              >
                Order
              </button>
            </div>
